        ...
        mReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot chidSnap : dataSnapshot.getChildren()){
                    ...
                    if (FirstRunSecondActivity.userUid.equals(chidSnap.child("VendorUid").getValue(String.class)) && (Integer.toString(cal.get(Calendar.DAY_OF_MONTH)) + "/" + Integer.toString(cal.get(Calendar.MONTH) + 1) + "/" + Integer.toString(cal.get(Calendar.YEAR))).equals(chidSnap.child("BookingDate").getValue(String.class))){
